...
function totp_get_config_val(){
    ...
    id_map['totp.timeStep']   = 'totp_timeStep_config';
...
function totp_get_config_params(){
    ...
    url_params['totp.timeStep'] 	= $('#totp_timeStep_config').val();
...
<form class="cmxform" id="form_totp_config" action="">
<fieldset>
...
<tr>
    <td class="description" colspan='2'>
        ...
        <label for="totp_rb_key_gen">${_("Generate random seed")}</label></td>
</tr>
<tr>
...
<tr class="set_pin_rows" >
    <td class="description"><label for="pin1" id="totp_pin1_label">${_("Enter PIN")}:</label></td>
    <td><input type="password" autocomplete="off" name="pin1" id="totp_pin1"
            class="text ui-widget-content ui-corner-all"></td>
</tr>
<tr class="set_pin_rows" >
    <td class="description"><label for="pin2" id="totp_pin2_label">${_("Confirm PIN")}:</label></td>
    <td><input type="password" autocomplete="off" name="pin2" id="totp_pin2"
            class="text ui-widget-content ui-corner-all"></td>
</tr>
</table>
% endif

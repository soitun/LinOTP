...
<div id="dialog_import_users_confirm">
    <p>${_("The user import from the selected file would result in the following changes. If results are as expected, you have to complete the import by confirming the changes.")}</p>
